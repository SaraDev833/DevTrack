...
const Pricing = () => {
  return (
    <div id='pricing' className='bg-linear-to-r from-purple-200/50 to-indigo-200/50  grid grid-cols-1 lg:grid-cols-[0.7fr_2fr_2fr_2fr] rounded-md gap-5 p-6 scroll-smooth' >
