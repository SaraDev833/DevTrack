  ...
  return (
        <div className="left flex flex-col gap-7 lg:w-[40%] mt-20 w-full md:order-2 lg:order-1">
                ...
                <div className="buttons flex gap-4 ">
                    ...
                    <button className='flex justify-center items-center rounded-lg text-black font-medium gap-2 border border-slate-700 lg:py-2 py-1 lg:px-4 px-3 text-sm cursor-pointer'><CirclePlay />Watch Demo</button>
                </div>
