...
// const completedTotalTasks = projects.reduce((total , project)=>{
//     const completedtaskFilter = project.tasks?.filter((task)=>(
//       task.status === "Completed"
//     ));
//     return (total + completedtaskFilter?.length || 0)
// },0)
// console.log(completedTotalTasks);
//   // const lists = [
//   //   {
//   //     name: "Website Design",
//   //     icon: <Globe size={20} />,
